...
export default function Item({nombre,cantidad,onDelete,onNuevoTexto,id}){
    ...
    if(!modoEdicion){
        jsxresultado = <li>{nombre} - {cantidad} <button onClick={entraEnEdicion}>Editar</button> <button onClick={()=> onDelete(id)}>Eliminar</button></li>
    }else
