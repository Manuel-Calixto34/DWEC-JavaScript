...
window.onload = () => {
    ...
    document.getElementById("btnCargar").addEventListener("click", ()=>{
        fetch("https://www.omdbapi.com/?s=star&apikey=9de3cf92&page="+contadorPaginas).then(response => response.json())
    .then(data => {
